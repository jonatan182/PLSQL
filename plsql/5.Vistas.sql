...
select * from vw_Categoria;--ejecutamos la vista normal nos muestra todos los registros incluyendo el ultimo que fue el 7
...
--introducimos nuevos registros en FAC_CATEGORIA no se se guardaran en la vista materializada hasta que nuevamente la actualicemos con este comando visto
